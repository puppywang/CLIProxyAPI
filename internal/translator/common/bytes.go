...
// WrapGeminiCLIResponse wraps a Gemini CLI response payload in the outer
// {"response": ...} envelope expected by Gemini CLI clients (monitor-feature
// addition; upstream does not ship the gemini-cli provider).
